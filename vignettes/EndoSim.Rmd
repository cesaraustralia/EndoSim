...
This plot shows us the proportions of aphids of different lifestages in the population at any given time. We can see there are large fluctuations in the proportion - while the proportion of adults generally decreases (which is what also leads to the final population collpase), there is a fluctation between periods of many 2^nd^ and 3^rd^ stars and periods of a majority of 1^st^ instars.
...
```{r counter, echo = FALSE, warning = FALSE}
...
```{r counter-explore-1, fig.dim = c(6,8)}
