...
#' @slot fun_fitness Function describing temperature-dependent relative fitness cost of R+ phenotype (0-1)
...
#' @slot fun_vert_trans Function describing temperature-dependent vertical transmission efficiency
