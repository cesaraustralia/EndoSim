...
#'   fun_sen_loss = EndosymbiontModel:::fit_gompertz(0.00188, 0.13),
#'   fun_dens_fecund = EndosymbiontModel:::fit_bannerman(10000, 0.0008),
#'   fun_temp_fecund = EndosymbiontModel:::fit_quadratic(-0.7611, 31.9847, 25),
#'   fun_age_fecund = EndosymbiontModel:::fit_weibull(58, 1.885, 5.953, 0),
#'   fun_alate_prod = EndosymbiontModel:::fit_alate(67.418, 0.993, 0.076, 300)
#'  )
#' 
#' GPA
